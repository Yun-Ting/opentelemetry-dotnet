// <copyright file="PrometheusExporterMiddlewareApplicationBuilderExtensions.cs" company="OpenTelemetry Authors">
...
namespace Microsoft.AspNetCore.Builder
{
    ...
    /// </summary>
    public static class PrometheusExporterMiddlewareApplicationBuilderExtensions
    {
        /// <summary>
        ...
        /// specified by <see
        /// cref="PrometheusExporterMiddlewareOptions.ScrapeEndpointPath"/>.</remarks>
        ...
        /// <see cref="PrometheusExporterMiddlewareOptions.ScrapeEndpointPath"/> is
        /// used.</remarks>
        /// <param name="app">The <see cref="IApplicationBuilder"/> to add
        /// middleware to.</param>
            ...
            Action<IApplicationBuilder> configureBranchedPipeline)
        {
            ...
            if (predicate == null)
            {
                if (path == null)
                {
                    var options = app.ApplicationServices.GetOptions<PrometheusExporterMiddlewareOptions>();

                    path = options.ScrapeEndpointPath ?? PrometheusExporterMiddlewareOptions.DefaultScrapeEndpointPath;
                }
